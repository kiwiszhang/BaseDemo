...
extension UILabel {
    @discardableResult
    func otoReFont(_ size: CGFloat) -> Self {
        font =  UIFont(name: Files.otomanopeeOneRegularTtf.name, size: size)!
        return self
    }
    
    @discardableResult
    func daruReFont(_ size: CGFloat) -> Self {
        font =  UIFont(name: Files.darumadropOneRegularTtf.name, size: size)!
        return self
    }
    
    @discardableResult
    func hnFont(size: CGFloat, weight: HelveticaNeueWeight = .regular) -> Self {
        self.font = UIFont.helveticaNeue(size: size, weight: weight)
        return self
    }
