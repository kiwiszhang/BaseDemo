...
class StrategyHeaderA: SuperCollectionReusableView, MeHomeSupplementaryProtocol {
    static let kind = UICollectionView.elementKindSectionHeader
    static let viewId = "StrategyHeaderA"
    
    private lazy var titleLab = UILabel().text("").color(.systemBlue).hnFont(size: 24.w).centerAligned()
